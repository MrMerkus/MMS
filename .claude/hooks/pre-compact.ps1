# GÜNCEL DEĞİL — 2026-09-09 B grubu: Linux (.sh) tarafı 🔮 zihin/ yapısına geçti,
# bu Windows karşılığı hâlâ eski 850-Companion düzenine bakıyor. Windows kullanılacaksa
# önce .sh dosyalarına göre yeniden yazılmalı.
